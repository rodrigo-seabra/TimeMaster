            ...
            <View style={styles.Container}>
                {cadastro && (<View >
                    ...
                    <FormComponent
                        ...
                        mostrarSenha
                    />
                    <TouchableOpacity onPress={() => (setCadastro(false), setLogin(true))} style={styles.trocaForm} >
                ...
                {login && (
                    <View>
                        ...
                        <FormComponent
                            ...
                            mostrarSenha
                        />
                        <TouchableOpacity onPress={() => (setLogin(false), setCadastro(true))} style={styles.trocaForm}>
                            <Text style={styles.TextTrocaForm}>Ainda não é usuário?</Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => (setLogin(false), setRecuperarSenha(true))} style={styles.trocaForm}>
